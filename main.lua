...
function loadimages()
	...
	gamebackgroundmultiA = newPaddedImage("graphics/gamebackgroundmultiA.png")
	multiresultsA = newPaddedImage("graphics/multiresultsA.png")
	...
	gamebackgroundmultiA:setFilter( "nearest", "nearest" )
	multiresultsA:setFilter( "nearest", "nearest" )
